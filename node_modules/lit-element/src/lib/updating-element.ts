...
export interface PropertyDeclaration<Type = unknown, TypeHint = unknown> {
   ...
   * it will be the userEntity's responsibility to call
...
export abstract class UpdatingElement extends HTMLElement {
   ...
   * `fooBar` property. Created lazily on userEntity subclasses when finalizing the
   * class.
   */
   ...
   * Created lazily on userEntity subclasses when finalizing the class.
   */
  ...
  static createProperty(
    ...
    // it would be lost otherwise and that would never be the userEntity's intention;
    // Instead, we expect users to call `requestUpdate` themselves from
    // userEntity-defined accessors. Note that if the super has an accessor we will
    // still overwrite it
