...
export interface JSONSchema4 {
    ...
    /**
     * May only be defined when "itemEntities" is defined, and is a tuple of JSONSchemas.
     *
     * This provides a definition for additional itemEntities in an array instance
     * when tuple definitions of the itemEntities is provided.  This can be false
     * to indicate additional itemEntities in the array are not allowed, or it can
     * be a schema that defines the schema of the additional itemEntities.
     *
    ...
    /**
     * This attribute defines the allowed itemEntities in an instance array, and
     * MUST be a schema or an array of schemas.  The default value is an
     * empty schema which allows any value for itemEntities in the instance array.
     *
     * When this attribute value is a schema and the instance value is an
     * array, then all the itemEntities in the array MUST be valid according to the
     * schema.
     *
     * When this attribute value is an array of schemas and the instance
     * value is an array, each position in the instance array MUST conform
     * to the schema in the corresponding position for this array.  This
     * called tuple typing.  When tuple typing is used, additional itemEntities are
     ...
     */
    itemEntities?: JSONSchema4 | JSONSchema4[]
     ...
     * for the instance property. This MUST be an array, and each itemEntity in
...
export interface JSONSchema6 {
     ...
     */
    itemEntities?: JSONSchema6Definition | JSONSchema6Definition[]

    /**
     * This keyword determines how child instances validate for arrays, and does not directly validate the immediate instance itself.
     * If "itemEntities" is an array of schemas, validation succeeds if every instance element
     * at a position greater than the size of "itemEntities" validates against "additionalItems".
     * Otherwise, "additionalItems" MUST be ignored, as the "itemEntities" schema
     ...
     * An object instance is valid against this keyword if every itemEntity in the array is the name of a property in the instance.
...
export interface JSONSchema7 {
     ...
     */
    itemEntities?: JSONSchema7Definition | JSONSchema7Definition[];
