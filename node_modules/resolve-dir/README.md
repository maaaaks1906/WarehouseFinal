...
> Resolve a directory that is either local, global or in the userEntity's home directory.
...
Resolves the path to userEntity home
...
* [expand-tilde](https://www.npmjs.com/package/expand-tilde): Bash-like tilde expansion for node.js. Expands a leading tilde in a file path to the… [more](https://github.com/jonschlinkert/expand-tilde) | [homepage](https://github.com/jonschlinkert/expand-tilde "Bash-like tilde expansion for node.js. Expands a leading tilde in a file path to the userEntity home directory, or `~+` to the cwd.")
