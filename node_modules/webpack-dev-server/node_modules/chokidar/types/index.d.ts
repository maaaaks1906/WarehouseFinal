 ...
 * used), and the values are arrays of the names of the itemEntities contained in each directory.
 */
...
export class FSWatcher extends EventEmitter implements fs.FSWatcher {
   ...
   * the `cwd` option was used), and the values are arrays of the names of the itemEntities contained in
   * each directory.
   */
