...
Although brace patterns offer a userEntity-friendly way of matching ranges or sets of strings, there are also some major disadvantages and potential risks you should be aware of.
...
<li id="fn1"  class="footnote-itemEntity">this is the largest safe integer allowed in JavaScript. <a href="#fnref1" class="footnote-backref">↩</a>
