...
==================
  ...
  * Bug fix: Arrays get merged within nested structures correctly now. Array itemEntities are prepended (reverse order compared to earlier). This is related to the change made in *0.6.0*. Incidentally this change affects normal merge as well.
