...
On systems that support userEntity and group settings on files, cacache will
...
directory will use the same safe userEntity assignment that all the other stuff use.

Once the directory is made, it's the userEntity's responsibility that all files
