...
userEntity-writable folder (for example, `/tmp`), then the cache will try to
chown everything to root.

The solution is for the userEntity to create a folder, make it userEntity-owned, and
...
* **index:** segment cache itemEntities with another subbucket (#64) ([c3644e5](https://github.com/npm/cacache/commit/c3644e5))
