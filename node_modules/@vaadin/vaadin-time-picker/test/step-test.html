...
describe('step test', () => {
  ...
  it('should have dropdown itemEntities if step is undefined', () => {
    timePicker.step = undefined;
    expect(timePicker.__dropdownItems.length).to.be.equal(24);
  });

  it('should have dropdown itemEntities if step is bigger or equal than 15min', () => {
    timePicker.step = 15 * 60;
    expect(timePicker.__dropdownItems.length).to.be.equal(96);
  });

  it('should not have dropdown itemEntities if step is lesser than 15min', () => {
