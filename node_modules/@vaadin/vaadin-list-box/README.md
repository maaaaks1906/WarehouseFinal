...
```html
  <vaadin-list-box selected="2">
    <b>Select an Item</b>
    <vaadin-itemEntity>Item one</vaadin-itemEntity>
    <vaadin-itemEntity>Item two</vaadin-itemEntity>
    <hr>
    <vaadin-itemEntity>Item three</vaadin-itemEntity>
    <vaadin-itemEntity>Item four</vaadin-itemEntity>
  </vaadin-list-box>
```
