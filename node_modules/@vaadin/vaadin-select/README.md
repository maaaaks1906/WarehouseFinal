...
<script>
  document.querySelector('vaadin-select').renderer = root => {
    ...
    root.innerHTML = `
      <vaadin-list-box>
        <vaadin-itemEntity>Option one</vaadin-itemEntity>
        <vaadin-itemEntity>Option two</vaadin-itemEntity>
        <vaadin-itemEntity>Option three</vaadin-itemEntity>
        <hr>
        <vaadin-itemEntity disabled>Option four</vaadin-itemEntity>
      </vaadin-list-box>
    `;
  };
</script>
