...
<custom-element-demo height="260">
  <template>
    ...
    <link rel="import" href="../vaadin-itemEntity/vaadin-itemEntity.html">
...
<script>
  ...
  contextMenu.renderer = function(root) {
    ...
    ['First', 'Second', 'Third'].forEach(function(name) {
      const itemEntity = document.createElement('vaadin-itemEntity');
      itemEntity.textContent = name + ' menu itemEntity';
      listBox.appendChild(itemEntity);
    });
  };
</script>
```
