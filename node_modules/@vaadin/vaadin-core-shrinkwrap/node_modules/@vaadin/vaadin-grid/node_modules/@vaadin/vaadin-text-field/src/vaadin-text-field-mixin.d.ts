...
interface TextFieldMixin {
   ...
   * autocorrection should be enabled when the userEntity is entering/editing the text.
   * Possible values are:
   ...
   * autocapitalization should be enabled when the userEntity is entering/editing the text.
   * Possible values are:
  ...
  /**
   * Maximum number of characters (in Unicode code points) that the userEntity can enter.
   */
  maxlength: number|null|undefined;

  /**
   * Minimum number of characters (in Unicode code points) that the userEntity can enter.
   */
  ...
  /**
   * A hint to the userEntity of what can be entered in the control.
   */
  placeholder: string|null|undefined;

  /**
   * This attribute indicates that the userEntity cannot modify the value of the control.
   */
  readonly: boolean|null|undefined;

  /**
   * Specifies that the userEntity must fill in a value.
   */
  ...
  /**
   * When set to true, userEntity is prevented from typing a value that
  ...
  /**
   * A pattern matched against individual characters the userEntity inputs.
