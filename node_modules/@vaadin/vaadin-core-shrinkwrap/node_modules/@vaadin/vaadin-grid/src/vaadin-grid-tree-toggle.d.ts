 ...
 * that provides toggle and level display functionality for the itemEntity tree.
 *
 * #### Example:
 * ```html
 * <vaadin-grid-column>
 ...
 * `leaf` | When present, the toggle is not expandable, i. e., the current itemEntity is a leaf | :host
 *
