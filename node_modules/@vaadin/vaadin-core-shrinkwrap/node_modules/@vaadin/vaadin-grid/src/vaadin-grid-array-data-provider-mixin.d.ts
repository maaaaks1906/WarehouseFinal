...
interface ArrayDataProviderMixin {
  ...
  /**
   * An array containing the itemEntities which will be stamped to the column template
   * instances.
   */
  itemEntities: GridItem[]|null|undefined;
  _arrayDataProvider(opts: GridDataProviderParams|null, cb: GridDataProviderCallback|null): void;

  /**
   * Check array of filters/sorters for paths validity, console.warn invalid itemEntities
   *
   ...
   */
  _checkPaths(arrayToCheck: Array<GridFilter|GridSorter>, action: string, itemEntities: GridItem[]): any;
  ...
  _filter(itemEntities: GridItem[]): GridItem[];
}
