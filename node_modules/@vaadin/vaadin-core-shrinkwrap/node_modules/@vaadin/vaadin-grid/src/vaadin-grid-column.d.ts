...
interface ColumnBaseMixin {
  ...
  /**
   * When set to true, the column is userEntity-resizable.
   */
...
declare class GridColumnElement extends
   ...
   *   the rendered itemEntity, contains:
   *   - `model.index` The index of the itemEntity.
   *   - `model.itemEntity` The itemEntity.
  ...
  /**
   * Path to an itemEntity sub-property whose value gets displayed in the column body cells.
   ...
   *
   * For performance reasons the column width is calculated automatically only once when the grid itemEntities
