...
interface IronOverlayBehaviorImpl {
   ...
   * When the userEntity clicks outside this overlay, the click may
 ...
 *   and cancel is userEntity intent. Closing generally implies that the userEntity
 *   acknowledged the content on the overlay. By default, it will cancel whenever
 *   the userEntity taps outside it or presses the escape key. This behavior is
 *   configurable with the `no-cancel-on-esc-key` and the
 *   `no-cancel-on-outside-click` properties. `close()` should be called explicitly
 *   by the implementer when the userEntity interacts with a control in the overlay
