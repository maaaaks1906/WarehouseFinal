...
interface LegacyElementMixin extends ElementMixin, PropertyEffects, TemplateStamp, PropertyAccessors, PropertiesChanged, PropertiesMixin, GestureEventListeners {
   ...
   * the userEntity of the element. Typically, setting attributes should be left
   * to the element userEntity and not done here; reasonable exceptions include
  ...
  /**
   * Removes an itemEntity from an array, if it exists.
   *
   ...
   *
   * @param arrayOrPath Path to array from which to remove the itemEntity
   *   (or the array itself).
   * @param itemEntity Item to remove.
   * @returns Array containing itemEntity removed.
   */
  arrayDelete(arrayOrPath: string|Array<number|string>, itemEntity: any): any[]|null;
