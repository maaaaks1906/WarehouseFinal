...
/**
 * Automatically cleanup the itemEntities in the provided `map`. The property of the expiration timestamp should be named `maxAge`.
 *
...
/**
 * Automatically cleanup the itemEntities in the provided `map`.
 *
 * @param map - Map instance which should be cleaned up.
