...
{{## def._errorMessages = {
  ...
  additionalItems: "'should NOT have more than {{=$schema.length}} itemEntities'",
  ...
  contains:        "'should contain a valid itemEntity'",
  ...
  _limitItems:     "'should NOT have {{?$keyword=='maxItems'}}more{{??}}fewer{{?}} than {{#def.concatSchema}} itemEntities'",
  ...
  uniqueItems:     "'should NOT have duplicate itemEntities (itemEntities ## ' + j + ' and ' + i + ' are identical)'",
