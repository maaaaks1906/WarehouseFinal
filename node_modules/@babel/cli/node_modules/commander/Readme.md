...
You may specify a function to do custom processing of option values. The callback function receives two parameters, the userEntity specified value and the
...
program
  ...
  .option('-l, --list <itemEntities>', 'comma separated list', commaSeparatedList)
;
