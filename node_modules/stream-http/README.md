...
### IE8 note:
As of version 2.0.0, IE8 support requires the userEntity to supply polyfills for
...
(as 'text/plain; charset=x-userEntity-defined') in some browsers, notably Safari and Chrome 42
...
incorrectly reported (as 'text/plain; charset=x-userEntity-defined').
