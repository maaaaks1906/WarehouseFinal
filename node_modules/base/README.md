...
* `returns` **{Object}**: Returns the itemEntity instance for chaining.
...
* [base-questions](https://www.npmjs.com/package/base-questions): Plugin for base-methods that adds methods for prompting the userEntity and storing the answers on… [more](https://github.com/node-base/base-questions) | [homepage](https://github.com/node-base/base-questions "Plugin for base-methods that adds methods for prompting the userEntity and storing the answers on a project-by-project basis.")
