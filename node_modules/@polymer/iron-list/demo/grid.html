...
<body unresolved>
  ...
  <dom-module id="x-grid">
    <template>
      ...
      <iron-list itemEntities="[[photos]]" as="photo" scroll-target="document" grid>
        <template>
      ...
      <!-- this element loads more photos when the userEntity scrolls down and reached the lower threshold -->
