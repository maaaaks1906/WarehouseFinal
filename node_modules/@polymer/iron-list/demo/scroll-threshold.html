...
<body unresolved>
  ...
  <dom-module id="x-app">
    <template>
      ...
      <iron-list id="list" itemEntities="[]" as="person" scroll-target="document">
        <template>
          <div>
      ...
      <!-- this element will load more data when the userEntity scrolls down and reached the lower threshold -->
      ...
      Polymer({
        ...
        _didRespond: function(e) {
          ...
          people.forEach(function(person) {
            this.$.list.push('itemEntities', person);
          }, this);
          // Clear the lower threshold so we can load more data when the userEntity scrolls
          // down again.
