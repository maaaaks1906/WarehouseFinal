...
- Add userEntity-importable files to `bower.json`'s `main` field for modulizer. ([commit](https://github.com/Polymer/polymer/commit/40e312f8))
...
- Ensure re-sort/filter always happens after array itemEntity set. Fixes #3626 ([commit](https://github.com/Polymer/polymer/commit/f6d4771c))
...
- Updated the README.md for a non-technical userEntity to understand ([commit](https://github.com/Polymer/polymer/commit/0729cef))
...
- Remove notify for itemEntities (unnecessary). ([commit](https://github.com/Polymer/polymer/commit/a370860))
...
- Add tests. Reset selection on itemEntities/multi change. Remove async. ([commit](https://github.com/Polymer/polymer/commit/5bca55b))
...
- nested dom-repeat with sort attribute shows duplicate entries when adding new itemEntities. [\#1744](https://github.com/Polymer/polymer/issues/1744)
...
- Allow userEntity prevention of `tap` and `track` gestures from `down` [\#1843](https://github.com/Polymer/polymer/pull/1843) ([azakus](https://github.com/azakus))
...
- Events for paper-menu or paper-itemEntity [\#1708](https://github.com/Polymer/polymer/issues/1708)
...
- \[0.9\] when I move a dom-repeat element from one parent to another, the itemEntities will gone [\#1498](https://github.com/Polymer/polymer/issues/1498)
...
- Polymer 0.8 cant bind to array itemEntity. [\#1409](https://github.com/Polymer/polymer/issues/1409)
...
- \[0.8\] `hostAttributes` should respect userEntity-provided defaults [\#1458](https://github.com/Polymer/polymer/issues/1458)
...
- Change userEntity `constructor` to `factoryImpl` as an aid to compilation tool... [\#1437](https://github.com/Polymer/polymer/pull/1437) ([sorvell](https://github.com/sorvell))
...
- core-itemEntity ignores clicks on polymer-project.org in Firefox [\#968](https://github.com/Polymer/polymer/issues/968)
...
- \<paper-itemEntity\> has 'iconSrc' attribute, should be 'src' like \<paper-fab\>, \<paper-icon-button\> and \<paper-menu-button\> [\#889](https://github.com/Polymer/polymer/issues/889)
...
- Consider adding support for loading userEntity selectable css resources per element [\#219](https://github.com/Polymer/polymer/issues/219)
...
- Cloned attributes should not override userEntity attributes in markup [\#190](https://github.com/Polymer/polymer/issues/190)
...
- polymer-ui-menu-itemEntity does not show the icon [\#365](https://github.com/Polymer/polymer/issues/365)
