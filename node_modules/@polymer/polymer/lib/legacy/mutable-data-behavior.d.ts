 ...
 * userEntity to make a deep modification to a bound object graph, and then either
 * simply re-set the object (e.g. `this.itemEntities = this.itemEntities`) or call `notifyPath`
 * (e.g. `this.notifyPath('itemEntities')`) to update the tree.  Note that all
