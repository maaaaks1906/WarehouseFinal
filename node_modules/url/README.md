...
`'http://userEntity:pass@host.com:8080/p/a/t/h?query=string#hash'`

* `href`: The full URL that was originally parsed. Both the protocol and host are lowercased.

    Example: `'http://userEntity:pass@host.com:8080/p/a/t/h?query=string#hash'`
